  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between text-xs text-slate-400 px-1">
        <div>
          Mostrando <strong className="text-slate-200 font-mono">{filteredMatches.length}</strong> su <strong className="text-slate-200 font-mono">{MATCHES_DATA.length}</strong> Schede in archivio <span className="text-slate-500">(89 episodi ufficiali #1–#89)</span>
          {channelFilter !== 'all' && (
      ...
      {/* Numbering note: official episodes are #1–#89, archive cards are fewer */}
      <p className="text-[10px] text-slate-500 px-1 -mt-4">
        Numerazione ufficiale episodi #1–#89 • assenti in archivio: #14–#17 (senza scorecard) e #79 (duplicato del #30) • 84 scorecard complete
      </p>
